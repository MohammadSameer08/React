...
This project teaches React Context API step by step with explanations in separate files.
...
Start with `01-what-is-context-api.md` and go through each file in order.

## 💾 Code Examples

- `SimpleContext.jsx` - Context creation
- `SimpleProvider.jsx` - Provider component
- `Counter.jsx` - Component using context
- `Display.jsx` - Another component using same context
